...
class _CategoryClient implements CategoryClient {
  _CategoryClient(this._dio, {this.baseUrl}) {
  ...
  Future<HttpResponse<List<Category>>> getCategories() async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<Category>>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'Category/CategoryList',
  ...
  Future<HttpResponse<Category>> getCategoryById(id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<Category>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'Category/CategorybyId',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
