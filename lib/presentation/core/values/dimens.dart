...
class Margin {
  ...
  static final b50 = CustomEdgeInsets().only(bottom: 50);
  ...
  static final v16h20 = CustomEdgeInsets().symmetric(vertical: 16, horizontal: 20);
}
...
class Spacing {
  ...
  static final v25 = SizedBox(height: 25.toHeight);
