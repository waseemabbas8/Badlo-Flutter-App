...
class _CommentClient implements CommentClient {
  ...
  @override
  Future<HttpResponse<List<Comment>>> getComments(productId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'prodId': productId};
  ...
  @override
  Future<HttpResponse<String>> addComment(comment) async {
    const _extra = <String, dynamic>{};
